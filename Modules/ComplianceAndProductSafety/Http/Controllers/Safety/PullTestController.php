...
class PullTestController extends Controller
{
    ...
    {
        return view('complianceandproductsafety::templates.safety.pull-test.setup');
    }

    public function report()
    {
        return view('complianceandproductsafety::templates.safety.pull-test.report');
    }

    public function inspector()
    {
        return view('complianceandproductsafety::templates.safety.pull-test.inspector');
    }
