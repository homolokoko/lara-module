...
class ComplianceCheckListController extends Controller
{
    ...
    {
        return view('complianceandproductsafety::templates.safety.checklist-of-compliance.setup');
    }

    public function report()
    {
        return view('complianceandproductsafety::templates.safety.checklist-of-compliance.report');
    }

    public function inspector()
    {
        return view('complianceandproductsafety::templates.safety.checklist-of-compliance.inspector');
    }
