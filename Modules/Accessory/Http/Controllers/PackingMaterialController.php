...
class PackingMaterialController extends Controller
{
    ...
    {
        return view('accessory::packing-material.audit');
    }


    public function testing()
    {
        return view('accessory::packing-material.testing');
    }

    public function approval()
    {
        return view('accessory::packing-material.approval');
    }

    public function inspection()
    {
        return view('accessory::packing-material.inspection');
    }
}
